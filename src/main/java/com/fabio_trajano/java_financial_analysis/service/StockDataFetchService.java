...
public class StockDataFetchService {
    ...
    public Double price(TickerRequest tickerRequest) {

        String priceUrl = "https://financialmodelingprep.com/api/v3/quote-short/" + tickerRequest.getTicker() + "?apikey=" + apiKey;
        ...
        try {
            ...
            return stockResponseDTOs[0].getPrice();
